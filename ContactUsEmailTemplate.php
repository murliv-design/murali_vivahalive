                ...
                * {font-family: Arial, Helvetica, sans-serif !important;}
                ...
                <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700,300&subset=latin,cyrillic,greek" rel="stylesheet" type="text/css">
                    ...
                    <body  style="font-size:12px; width:100%; height:100%;">
                        ...
                        <table id="mainStructure" class="full-width" width="600" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; max-width: 600px; outline: rgb(239, 239, 239) solid 1px; box-shadow: rgb(224, 224, 224) 0px 0px 30px 5px; margin: 10px auto 10px auto;" bgcolor="#ffffff">
                            <!-- START ORDER-TABLE -->
                            <tr>
                                                    ...
                                                    <tr dup="0">
                                                        <td valign="top">
                                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0px auto; min-width: 100%;" role="presentation">
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" width="600" style="width:100%;line-height:0px;" mc:edit="image-0">
                                                                        <img src="https://www.vivahalive.com/assets/img/logo_vivahalive_svg.svg" width="240" style="display: block !important; width:240px; max-width: 240px; margin: 0px 0px 0px 0px;" vspace="0" hspace="0" alt="image">
                                                                    </td>
                                                                </tr><!-- start space -->
                                                    ...
                                                    <tr dup="0">
                                                      <td valign="top">
                                                         <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0px auto; min-width: 100%;" role="presentation">
                                                            ...
                                                            <tr>
                                                               <td align="left" style="font-size: 24px; color: #333333; font-weight: bold; font-family: 'Open Sans', Arial, Helvetica, sans-serif; word-break: break-word; line-height: 1;">
                                                                  <span style="text-decoration: none; color: #333333; font-style: normal; text-align: center; line-height: 30px; font-size: 24px; font-weight: 700; font-family: 'Open Sans', Arial, Helvetica, sans-serif;">
                                                                    SUBJECT
                                                                  </span>
                                                               </td>
                                                            </tr><!-- start space -->
                                                    ...
                                                    <tr dup="0">
                                                        <td valign="top" align="center">
                                                            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0px auto; min-width: 100%;" role="presentation">
                                                                ...
                                                                <tr>
                                                                    <td valign="top">
                                                                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color: #e1edf4; margin: 0px auto; min-width: 100%;" role="presentation" bgcolor="#e1edf4">
                                                                            <tr dup="0" style="NAME_STYLE">
                                                                                <td valign="top" height="25" width="100" style="font-size: 14px; color: #333333; font-weight: normal; font-family: 'Open Sans', Arial, Helvetica, sans-serif; word-break: break-word; padding: 15px; line-height: 1;" align="left"><span style="font-style: normal; text-align: left; color: #333333; line-height: 24px; font-size: 14px; font-weight: 400; font-family: 'Open Sans', Arial, Helvetica, sans-serif;">
                                                                                       Name :
                                                                                    </span></td>
                                                                                <td valign="top" style="background-color:#fafafa; border: 1px solid #e1edf4;" bgcolor="#fafafa">
                                                                                    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="height: 100%; margin: 0px auto; min-width: 100%;" role="presentation">
                                                                                        <tr>
                                                                                            <td valign="top" style="font-size: 14px; color: #888888; font-weight: normal; font-family: 'Open Sans', Arial, Helvetica, sans-serif; word-break: break-word; padding: 15px; line-height: 1;" align="left"><span style="font-style: normal; text-align: left; color: #888888; line-height: 24px; font-size: 14px; font-weight: 400; font-family: 'Open Sans', Arial, Helvetica, sans-serif;">
                                                                                                   NAME
                                                                                                </span></td>
                                                                                        </tr><!-- start space -->
                                                                                        <tr>
